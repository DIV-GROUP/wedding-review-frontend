...
import Image1 from '../images/photos2.jpg';
import Image2 from '../images/picc2.jpg';
import Image3 from '../images/picc3.jpg';
import Image4 from '../images/picc4.jpg';
...
export default function Photo() {
    return (
        <div>
            ...
            <Container fluid >
                ...
                <Row>
                    <Col className="dark-background">
                        <div>
                            <h6><hr />CAPTURE THE SWEET MOMENT<hr /></h6>
                            <h2>PHOTOGRAPHY</h2>
            ...
            <div className='photo-head'><h2>PHOTOGRAPHERS</h2></div>
