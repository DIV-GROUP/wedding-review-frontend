...
import Image1 from '../images/ring1.jpg';
import Image2 from '../images/ring2.jpg';
import Image3 from '../images/ring3.jpg';
import Image4 from '../images/ring4.jpg';
import Image5 from '../images/ring5.jpg';
import Image6 from '../images/ring6.jpg';
...
export default function Rings() {
    return (
        <div>
            ...
            <Container fluid >
                <Row>
                    <Col className="dark-background">
                        <div>
                            <h6><hr />COMPLETELY BONDED FOREVER<hr /></h6>
                            <h2>RINGS</h2>
            ...
            <div className='photo-head'><h2>RINGS</h2></div>
